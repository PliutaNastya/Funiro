(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-main__slider")) new core(".slider-main__slider", {
            ...
            navigation: {
                prevEl: ".controlls-slider-main__arrows .slider-arrow__prev",
                nextEl: ".controlls-slider-main__arrows .slider-arrow__next"
            },
            on: {}
        });
        if (document.querySelector(".rooms__slider")) new core(".rooms__slider", {
            ...
            navigation: {
                prevEl: ".rooms__arrows .slider-arrow__prev",
                nextEl: ".rooms__arrows .slider-arrow__next"
            },
            on: {}
        });
        if (document.querySelector(".tips__slider")) new core(".tips__slider", {
            ...
            navigation: {
                prevEl: ".tips__arrows .slider-arrow__prev",
                nextEl: ".tips__arrows .slider-arrow__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        ...
        document.addEventListener("click", (({target}) => {
            if (!target.closest(".search-form") && document.querySelector(".search-form._active")) searchForm.classList.remove("_active");
        }));
    }));
